...
func newNoteV2Command(registryFactory vaultRegistryFactory, serviceFactory noteServiceFactory) *cobra.Command {
	var common commonFlags
	command := &cobra.Command{
		Use:   "note",
		Short: "Read and safely mutate notes through the obs-cli V2 protocol",
