...
func noteCommandDependencies(t *testing.T) (vaultRegistryFactory, noteServiceFactory, string) {
	...
	registry := obsidian.NewRegistry(config.NewStore(filepath.Join(root, "config.json")))
...
func TestNoteReadAnalyzeConditionalUpdateLifecycle(t *testing.T) {
...
func TestNoteDryRunAndInputSafety(t *testing.T) {
	registryFactory, serviceFactory, vaultRoot := noteCommandDependencies(t)
...
func TestNotePatchConflictAndDangerousReplaceGuard(t *testing.T) {
...
func TestNoteDeleteRequiresMatchingRevision(t *testing.T) {
	registryFactory, serviceFactory, vaultRoot := noteCommandDependencies(t)
...
func TestNoteMoveDryRunAndApply(t *testing.T) {
	registryFactory, serviceFactory, vaultRoot := noteCommandDependencies(t)
...
func executeNoteCommandResult(
	...
	t.Helper()
	command := newNoteCommand(registryFactory, serviceFactory)
