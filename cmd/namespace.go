...
func newNamespace(use, short string, common *commonFlags) *cobra.Command {
...
func namespaceArgs(common *commonFlags, operation string, validate cobra.PositionalArgs) cobra.PositionalArgs {
