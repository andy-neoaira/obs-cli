...
- [x] 当前 README 和规范只描述 V1。
- [x] 当前文档没有 V1→V2 产品叙事。
- [x] 旧阶段计划已删除，仓库中没有复制的历史归档。
- [x] 当前导航不链接已删除的旧规范。
- [x] 所有相对链接有效。
- [x] LICENSE、派生说明和 THIRD_PARTY_NOTICES 保留。
- [x] 中英文文档关键版本、协议和配置路径一致。
...
- 完成日期：`2026-07-28`
- obs-cli 提交：`bb2a823`
- miniobsidian.nvim 提交：`919c14f`
- 删除文件：`55 个历史计划、迁移、审计与旧 RC 文档`
- 保留的合规文档：`LICENSE、THIRD_PARTY_NOTICES.md 与 Git 历史`
