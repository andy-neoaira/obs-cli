...
- [x] [P3-T08 Skill 场景评测与发布门禁](./P3-T08-skill-evals.md)

推荐顺序：P3-T01 → P3-T02/P3-T03/P3-T04/P3-T05 → P3-T06 → P3-T07 → P3-T08。

## 阶段完成标准

- [x] 所有 Skill 执行前检查 capability。
- [x] 所有修改型 Skill 先 dry-run，再按授权策略执行。
- [x] 所有更新型 Skill处理 `REVISION_CONFLICT`。
- [x] 每个 Skill 有触发、非触发、成功、冲突和失败测试。
- [x] Skill 输出包含修改摘要和验证结果。
