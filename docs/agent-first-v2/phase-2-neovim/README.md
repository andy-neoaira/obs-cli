...
- [ ] [P2-T05 外部修改检测与缓存失效](./P2-T05-external-changes.md)
- [ ] [P2-T06 CWD、配置、Health 与文档收口](./P2-T06-ux-cleanup.md)
...
- [ ] 无 CLI 时所有基础功能完整可用。
- [ ] 共享 fixture 在 Lua 测试中通过。
- [ ] 不存在 Vault 路径逃逸和同名笔记静默误选。
- [ ] Daily Note 与 Obsidian/CLI 语义一致。
- [ ] 外部修改不会静默覆盖未保存 buffer。
- [ ] Stylua、静态检查、headless 测试和 CI 通过。
