...
| `github.com/lucasb-eyer/go-colorful` | v1.2.0 | MIT | `vendor/github.com/lucasb-eyer/go-colorful/LICENSE` |
| `github.com/mattn/go-runewidth` | v0.0.16 | MIT | `vendor/github.com/mattn/go-runewidth/LICENSE` |
| `github.com/nsf/termbox-go` | v1.1.1 | MIT-style | `vendor/github.com/nsf/termbox-go/LICENSE` |
| `github.com/pkg/errors` | v0.9.1 | BSD-2-Clause | `vendor/github.com/pkg/errors/LICENSE` |
...
| `github.com/skratchdot/open-golang` | 2020-01-16 | MIT | `vendor/github.com/skratchdot/open-golang/LICENSE` |
...
| `golang.org/x/term` | v0.43.0 | BSD-3-Clause | `vendor/golang.org/x/term/LICENSE` |
| `golang.org/x/text` | v0.24.0 | BSD-3-Clause | `vendor/golang.org/x/text/LICENSE` |
