...
完整决策见 [ADR-001：Agent-first 产品边界与三入口架构](./docs/architecture/ADR-001-agent-first-boundary.md)，配置边界见 [V2 配置规范](./docs/spec/CONFIG_V2.md)，执行任务见 [V2 联合改造计划](./docs/agent-first-v2/README.md)。
