...
See [ADR-001: Agent-first Product Boundary and Three-client Architecture](./docs/architecture/ADR-001-agent-first-boundary.md), the [V2 configuration boundary](./docs/spec/CONFIG_V2.md), the [Vault path policy](./docs/spec/PATH_POLICY.md), and the [V2 execution plan](./docs/agent-first-v2/README.md).
